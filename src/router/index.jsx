...
const mainRoutes = [
  ...
  {
    path: "contacts",
    element: <Suspense fallback={<LoadingFallback />}><Contacts /></Suspense>
  },
  {
    path: "pipeline",
    element: <Suspense fallback={<LoadingFallback />}><Pipeline /></Suspense>
  },
  {
    path: "deals",
    element: <Suspense fallback={<LoadingFallback />}><Deals /></Suspense>
  },
  {
    path: "*",
